        ...
        public void Solve () {
            ...
            */
            ...
            for(int a = N; a>(int)Math.Ceiling((double)N/3); a--) {
                ...
                for(int b = Math.Min(N-a, a); b>(N-a)/2; b--) {

                    int c = N - a - b;
                    if (c > b || b > a) {throw new Exception("Error in loop for counting");}
                ...
                //Console.WriteLine($"a={a}, count={count}");
            } 
            Console.WriteLine($"Final Count: {count}");
        }
